...
class CalculatorCore {
  ...
  /// Gets the mean longitude of the Sun in degrees.
  ///
  ...
  /// Gets the geometric mean anomaly of the Sun in degrees.
  ///
  ...
  /// Gets the geometric mean anomaly of the Sun in degrees, uncorrected.
  ///
  /// Anomaly here refers to the non-uniform apparent motion of the Sun and planets along the plane of the ecliptic.
  /// It is defined as the angular distance from perihelion which the Earth would have if it moved around the Sun with
  /// a constant angular velocity.
  ...
  /// Gets the eccentricity of the Earth orbit (unitless).
  ///
  ...
  /// Gets the Sun's equation of center, in degrees.
  ///
  ...
  /// Gets the true longitude of the Sun in degrees.
  ///
  ...
  /// Gets the true anomaly of the Sun in degrees.
  ///
  ...
  /// Gets the apparent longitude of the Sun in degrees.
  ///
  ...
  /// Gets the correction factor for nutation and aberration.
  ///
  ...
  /// Gets the mean obliquity of the ecliptic in degrees, that is the obliquity free from short-term variations.
  ///
  ...
  /// Gets the mean obliquity of the ecliptic in degrees, corrected for nutation and aberration.
  ...
  /// Gets the equation of time in minutes.
  ///
  ...
  /// Position of the Sun in the Equatorial Coordinate System.
  ///
  ...
  /// for the winter.
  EquatorialCoordinate get sunPosition {
    if (_sunPosition == null) {
      ...
      _sunPosition = EquatorialCoordinate(rightAscension.toDegrees(), declination.toDegrees());
    }
